...
import rentComputer from '../../backend/businesslogic_FR/rent';
...
describe('business logic rent computation', () => {
    describe('one property rented', () => {
        ...
        it('compute one rent', () => {
            const computedRent = rentComputer(contract, '01/01/2017', '31/01/2017');
            assert.equal(computedRent.total.grandTotal, grandTotal);
            assert(true);
        });

        it('compute two rents and check balance', () => {
            const rentOne = rentComputer(contract, '01/01/2017', '31/01/2017');
            const rentTwo = rentComputer(contract, '01/01/2017', '31/01/2017', null, rentOne);
    ...
    describe('two properties rented with one month offset', () => {
        ...
        it('compute one rent two properties should be billed', () => {
            const computedRent = rentComputer(contract, '01/02/2017', '28/02/2017');
