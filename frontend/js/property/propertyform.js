...
class PropertyForm extends Form {
  ...
  afterSetData(args) {
    ...
    if (property && property._id) {
      ...
      $(domSelector + ' #propertyNameLabel').html(
        i18next.t('Property to rent')
      );
  ...
  _computeRent() {
    ...
    $('#property-form-summary-rent').html(
      Helper.formatMoney(data.price, false, false)
    );
    $('#property-form-summary-expense').html(
      Helper.formatMoney(data.expense, false, false)
    );
    $('#property-form-summary-totla-rentwithexpenses').html(
